...
// Global pool caching across warm serverless invocations
...
module.exports = async function handler(req, res) {
  ...
  // 2. Submit Waitlist (POST /api/waitlist)
  if (pathname === '/api/waitlist' && method === 'POST') {
    ...
    try {
      ...
      console.error('Waitlist insertion error:', err.message);
      res.setHeader('Content-Type', 'application/json');
      res.statusCode = 500;
  ...
  // 3. Get Waitlist and Stats (GET /api/waitlist)
  ...
  // 4. Export CSV (GET /api/waitlist/export)
  ...
  // 5. Delete Entry (DELETE /api/waitlist/:id)
